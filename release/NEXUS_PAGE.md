...
- **NPC spawning**: spawn one or many NPCs/creatures at a directly entered distance, with counts up to 100,000 and Line, Matrix or Circle formations with adjustable spacing/radius; the same controls are available in the narrow NPC dock
