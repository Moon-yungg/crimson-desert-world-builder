...
namespace editor {
    ...
    void Toggle() {
        ...
        if (!g_open) { g_boxSelecting = g_boxMoved = g_boxAdd = false; g_boxBase.clear(); g_rightGesture = g_rightMoved = g_worldPopupRequested = false; g_rightUid = 0; g_browserDragPrefab = -1; }
