...
set MH=..\..\tools\minhook
set IM=..\..\tools\imgui
cl /nologo /std:c++17 /O2 /W3 /EHa /MT /DNDEBUG /D_CRT_SECURE_NO_WARNINGS /DIMGUI_DISABLE_OBSOLETE_FUNCTIONS=0 /DIMGUI_USER_CONFIG=\"cd_imconfig.h\" ^
   /I. /I%MH%\include /I%IM% /I%IM%\backends /Fo:build\ /LD ^
   cdmodkit.cpp diag.cpp overlay.cpp input.cpp editor.cpp thumbgen.cpp heap.cpp icons.cpp ^
   ...
   build\cdmodkit.res user32.lib comdlg32.lib shell32.lib d3d12.lib dxgi.lib d3dcompiler.lib /link /OUT:build\cdmodkit.asi
