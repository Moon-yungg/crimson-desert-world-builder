...
namespace core {
    ...
    void CameraControlStart();                 // capture the live pose; the final camera-state writer substitutes this pose while active
    void CameraControlStop();                  // stop substituting the pose; the game's next camera update resumes normally
